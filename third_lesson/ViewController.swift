...
//  third_lesson
//
//  Created by Маша Гудкова on 12.10.2024.
//
...
class ViewController: UIViewController {
    ...
    private func setupNumberPad() {
        ...
        clearButton.backgroundColor = .init(red: 1, green: 0.5, blue: 0.3, alpha: 1)
        ...
        for x in 0..<5 {
            ...
            button_operand.backgroundColor = .init(red: 0.9, green: 0.5, blue: 0.4, alpha: 1)
